            ...
            >
                ...
                <View style={tw('items-start p-5')}>
                    <View style={tw('mx-auto')}>
                        ...
                        <Text
                            style={tw('text-lg text-center text-white font-bold pb-5')}
                        >
                    ...
                    <View
                        style={tw('mx-auto pb-5')}
                    >
                        <Text
                            style={tw('text-base text-center text-white font-bold mt-5')}
                        >
                            Address
                        </Text>
                        <Text
                            style={tw('text-sm text-center text-white')}
                        >
                            {order.Address}, {order.City}
                        </Text>
                        <Text
                            style={tw('text-sm text-center text-white italic')}
                        >
